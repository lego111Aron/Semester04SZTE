...
public class ZeneController {
    ...
    public boolean update(Zene zene) {
        return dao.update(zene);
    }
    public boolean delete(Zene zene) { return dao.delete(zene); }
    public void preferences(Zene zene) { dao.preferences(zene); }
}
