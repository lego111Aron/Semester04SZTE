...
public interface ZeneDAO {
    ...
    default boolean update(Zene zene) { return false; } // interface tartalmazhat default metodusokat, ez alatalaban akkor hasznos, ha visszafele kell kompatibilis legyen az uj interface.
    default boolean delete(Zene zene) { return false; }

    default void preferences(Zene u) {}
}
